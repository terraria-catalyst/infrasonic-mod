...
public abstract class PersistentDataStore : ILoadable
{
    ...
    public void Load(Mod mod)
    {
        ...
        string path = TerraVoice.CachePath;
    ...
    public void ForceSave()
    {
        ...
        string currentPath = Path.Combine(TerraVoice.CachePath, FileName);
    ...
    public void LoadFromFile(string path)
    {
        ...
        {
            TerraVoice.Instance.Logger.Error($"Failed to load persistent data: {FileName}");
        }
    }
