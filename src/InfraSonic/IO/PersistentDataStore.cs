...
public abstract class PersistentDataStore : ILoadable
{
    ...
    public void Load(Mod mod)
    {
        ...
        string path = InfraSonic.CachePath;
    ...
    public void ForceSave()
    {
        ...
        string currentPath = Path.Combine(InfraSonic.CachePath, FileName);
    ...
    public void LoadFromFile(string path)
    {
        ...
        {
            InfraSonic.Instance.Logger.Error($"Failed to load persistent data: {FileName}");
        }
    }
